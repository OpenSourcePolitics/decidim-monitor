...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Decidim Monitor web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 4seaRZdkaSulRxYdloCi8mpF-z_uQpkUu4wG_Nz8PfE
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("decidim-monitor.log", "w"))
  #
  #
end
